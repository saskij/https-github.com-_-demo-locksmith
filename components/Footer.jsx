            ...
            <div className="footer__bottom">
                <div className="footer__bottom-inner">
                    ...
                    <nav className="footer__legal">
                        <Link href={getLocalizedPath('/privacy-policy')} className="footer__legal-link">Privacy Policy</Link>
                        <span className="footer__legal-sep">·</span>
                        <Link href={getLocalizedPath('/terms-and-conditions')} className="footer__legal-link">Terms & Conditions</Link>
                        <span className="footer__legal-sep">·</span>
                        <Link href={getLocalizedPath('/sitemap.xml')} className="footer__legal-link">Sitemap</Link>
                    </nav>
                </div>
            </div>
        </footer>
