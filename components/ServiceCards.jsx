                            ...
                            <div className="service-card" data-aos="fade-up" data-aos-delay={index * 50}>
                                ...
                                <div className="service-card__body">
                                    ...
                                    <div className="service-card__actions">
                                        <button onClick={(e) => { e.preventDefault(); e.stopPropagation(); window.location.href = 'tel:+12086868099'; }} className="btn btn--primary service-card__call-btn" style={{ cursor: 'pointer' }}>
