            ...
            <div className="container" style={{ maxWidth: '1200px' }}>
                <div className="service-layout-grid">
                    ...
                    <div className="service-layout-text">
                        <h2 className="section-title" style={{ textAlign: 'left', margin: '0 0 24px 0', fontSize: '2.5rem' }}>{tr.sectionTitle}</h2>
                        <div style={{ fontSize: '1.1rem', color: 'var(--text-dark)', lineHeight: '1.8' }}>
                            ...
                            <div style={{ marginTop: '40px' }}>
                                <a href="tel:+12086868099" className="btn btn--primary btn--lg" style={{ display: 'inline-flex', alignItems: 'center', gap: '12px' }}>
