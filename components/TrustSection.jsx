    ...
    return (
        <section className="trust" id="reviews">
            <div className="container">
                ...
                <div className="trust__testimonials" style={{ display: 'flex', justifyContent: 'center', marginTop: '40px' }}>
                    <div className="google-reviews-placeholder" data-aos="fade-up" data-aos-delay="100" style={{
                        backgroundColor: '#fff',
                        borderRadius: '16px',
                        padding: '60px 20px',
                        textAlign: 'center',
                        ...
                        <h3 style={{ fontSize: '1.5rem', color: 'var(--navy)', marginBottom: '8px' }}>{tr.placeholderTitle}</h3>
                        <p style={{ color: 'var(--text-light)', fontSize: '1.1rem' }}>{tr.placeholderText}</p>
                        <div style={{ marginTop: '24px', fontSize: '0.9rem', color: 'rgba(0,0,0,0.4)' }}>
                            [ Widget / Embed Code Goes Here ]
                        </div>
                    </div>
                </div>
